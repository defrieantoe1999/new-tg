...
class Paths:
    WORK_PATH = "/root/Telegram-Leecher/BOT_WORK"
    THMB_PATH = "/root/Telegram-Leecher/colab_leecher/Thumbnail.jpg"
    VIDEO_FRAME = f"{WORK_PATH}/video_frame.jpg"
    HERO_IMAGE = f"{WORK_PATH}/Hero.jpg"
    DEFAULT_HERO =  "/root/Telegram-Leecher/custom_thmb.jpg"
    MOUNTED_DRIVE = "/root/drive"
    down_path = f"{WORK_PATH}/Downloads"
    temp_dirleech_path = f"{WORK_PATH}/dir_leech_temp"
    mirror_dir = "/root/drive/MyDrive/Colab Leecher Uploads"
    ...
    access_token = "/root/token.pickle"
